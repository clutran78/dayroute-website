...
import { Check, Smartphone, Users, Zap, Star, Crown } from "lucide-react";
        ...
        <div className="relative mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="text-center">
            ...
            <p className="mt-6 text-lg text-muted-foreground max-w-2xl mx-auto">
              Built for tradies, NDIS providers, cleaners, and mobile service professionals across Australia. 
              All plans include a <span className="text-primary font-semibold">7-day free trial</span>. Cancel anytime.
            </p>
      ...
      <section className="py-16 sm:py-24">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          ...
          <div className="mb-12 text-center sm:text-left">
            ...
            <h2 className="text-3xl font-bold">For individual professionals</h2>
            <p className="mt-4 text-muted-foreground">
              Perfect for tradies, cleaners, NDIS providers, and home-visit clinicians working solo.
            </p>
          </div>

          {/* Solo plan cards - 2 columns */}
      ...
      <section className="py-16 sm:py-24 bg-card/50">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          ...
          <div className="mb-12 text-center sm:text-left">
            ...
            <h2 className="text-3xl font-bold">For teams with multiple staff</h2>
            <p className="mt-4 text-muted-foreground">
              Coordinate your team with shared routes, location tracking, and admin controls.
              All team plans include a 7-day free trial.
            </p>
          </div>

          {/* Team plan cards - 2 columns */}
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 max-w-4xl mx-auto">
            {teamPlans.map((plan) => (
              <Card 
                key={plan.id} 
              ...
              >
                ...
                <CardContent className="flex-1">
                  ...
                  <div className="mb-6 p-3 rounded-lg bg-secondary/50">
                    <p className="text-sm">
                      <span className="font-medium">or {plan.yearlyPrice}/year</span>
                      <span className="ml-2 text-primary font-semibold">(Save 2 months)</span>
                    </p>
                  </div>
            ...
            <div className="space-y-8">
              <div>
                ...
                <p className="text-muted-foreground">
                  All plans start with a 7-day free trial. Download the app, pick your plan,
                  and enjoy full access. You can cancel anytime during the trial and won&apos;t be charged.
              ...
              <div>
                ...
                <p className="text-muted-foreground">
                  After 7 days, your subscription will automatically renew at the plan price you selected.
                  You&apos;ll keep full access to all features as long as your subscription is active.
                </p>
              </div>
              ...
              <div>
                ...
                <p className="text-muted-foreground">
                  DayRoute is launching first on iOS (iPhone & iPad). Android support is on our roadmap.
                  Join the waitlist to be notified when Android is available.
                </p>
              </div>
        ...
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="text-center">
            ...
            <p className="mt-4 text-lg text-muted-foreground max-w-2xl mx-auto">
              Join thousands of Australian tradies, NDIS providers, and mobile professionals 
              who plan smarter and finish faster with DayRoute.
            </p>
            <div className="mt-8">
