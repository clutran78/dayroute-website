          ...
          <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
            ...
            <div className="flex flex-wrap gap-2 sm:gap-3">
              {[
                ...
                { name: "Solar Installation", href: "/route-planning-for-service-businesses-australia" },
                ...
                { name: "Skip Bin & Waste Removal", href: "/route-planning-for-service-businesses-australia" },
                ...
                { name: "Stump Grinding", href: "/gardening-business-scheduling-invoicing-app-australia" },
                { name: "Glazier & Glass Repair", href: "/handyman-job-management-route-invoicing-app-australia" },
                { name: "Antenna & TV Installation", href: "/route-planning-for-service-businesses-australia" },
                { name: "Roller Door Repair", href: "/handyman-job-management-route-invoicing-app-australia" },
                { name: "Upholstery Cleaning", href: "/cleaning-business-scheduling-invoicing-app-australia" },
                { name: "Mattress Cleaning", href: "/cleaning-business-scheduling-invoicing-app-australia" },
                { name: "Oven Cleaning", href: "/cleaning-business-scheduling-invoicing-app-australia" },
                { name: "Mobile Car Wash", href: "/mobile-detailing-route-invoicing-app-australia" },
                { name: "Boat Detailing", href: "/mobile-detailing-route-invoicing-app-australia" },
                { name: "Caravan & RV Servicing", href: "/mobile-detailing-route-invoicing-app-australia" },
                { name: "Scaffolding", href: "/route-planning-for-service-businesses-australia" },
                ...
                { name: "Gas Fitting", href: "/hot-water-service-business-scheduling-invoicing-app-australia" },
                ...
                { name: "Demolition", href: "/route-planning-for-service-businesses-australia" },
                { name: "Asbestos Removal", href: "/route-planning-for-service-businesses-australia" },
                { name: "Fire Protection Services", href: "/route-planning-for-service-businesses-australia" },
                { name: "Signage & Wrapping", href: "/route-planning-for-service-businesses-australia" },
                { name: "Mobile Welding", href: "/route-planning-for-service-businesses-australia" },
                { name: "Air Duct Cleaning", href: "/cleaning-business-scheduling-invoicing-app-australia" },
                { name: "Grease Trap Cleaning", href: "/cleaning-business-scheduling-invoicing-app-australia" },
                { name: "Septic Tank Services", href: "/route-planning-for-service-businesses-australia" },
                { name: "Mobile Mechanic", href: "/blog/mobile-mechanic-business-guide-australia" },
                { name: "Bicycle Repair", href: "/route-planning-for-service-businesses-australia" },
                { name: "Tutoring & Education", href: "/route-planning-for-service-businesses-australia" },
                { name: "Music Lessons", href: "/route-planning-for-service-businesses-australia" },
                ...
                { name: "Real Estate Photography", href: "/route-planning-for-service-businesses-australia" },
                { name: "Drone Services", href: "/route-planning-for-service-businesses-australia" },
                { name: "Surveying", href: "/route-planning-for-service-businesses-australia" },
                { name: "Building Inspection", href: "/route-planning-for-service-businesses-australia" },
              ].map((service) => (
                <Link
                  key={service.name}
                  href={service.href}
