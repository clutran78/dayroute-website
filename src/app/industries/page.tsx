        ...
        <section className="py-12 sm:py-20 border-t border-border">
          <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
            ...
            <div className="flex flex-wrap gap-2 sm:gap-3">
              {[
                { name: "Painting & Decorating", href: "/blog/painting-business-job-management-invoicing-australia" },
                { name: "Roofing", href: "/blog/roofing-business-scheduling-invoicing-tips-australia" },
                { name: "Fencing", href: "/blog/fencing-business-job-management-tips-australia" },
                { name: "Carpet Cleaning", href: "/blog/carpet-cleaning-business-route-planning-australia" },
                { name: "Window Cleaning", href: "/blog/window-cleaning-business-scheduling-pricing-australia" },
                { name: "Gutter Cleaning", href: "/blog/gutter-cleaning-business-pricing-route-planning-australia" },
                { name: "Solar Panel Cleaning", href: "/blog/solar-panel-cleaning-business-guide-australia" },
                { name: "Solar Installation", href: "/blog/installation-services-scheduling-job-management-australia" },
                { name: "Tree Services & Arborist", href: "/blog/tree-services-arborist-scheduling-route-planning-australia" },
                { name: "Concreting & Paving", href: "/blog/specialist-trades-job-scheduling-tips-australia" },
                { name: "Tiling", href: "/blog/specialist-trades-job-scheduling-tips-australia" },
                { name: "Plastering & Rendering", href: "/blog/specialist-trades-job-scheduling-tips-australia" },
                { name: "Skip Bin & Waste Removal", href: "/blog/waste-environmental-services-scheduling-australia" },
                { name: "House Washing", href: "/blog/house-washing-business-pricing-route-planning-australia" },
                { name: "Lawn Care & Turf", href: "/blog/lawn-care-business-startup-guide-australia" },
                { name: "Stump Grinding", href: "/blog/tree-services-arborist-scheduling-route-planning-australia" },
                { name: "Glazier & Glass Repair", href: "/blog/installation-services-scheduling-job-management-australia" },
                { name: "Antenna & TV Installation", href: "/blog/installation-services-scheduling-job-management-australia" },
                { name: "Roller Door Repair", href: "/blog/installation-services-scheduling-job-management-australia" },
                { name: "Upholstery Cleaning", href: "/blog/specialist-cleaning-business-scheduling-australia" },
                { name: "Mattress Cleaning", href: "/blog/specialist-cleaning-business-scheduling-australia" },
                { name: "Oven Cleaning", href: "/blog/specialist-cleaning-business-scheduling-australia" },
                { name: "Mobile Car Wash", href: "/blog/mobile-vehicle-services-scheduling-route-planning-australia" },
                { name: "Boat Detailing", href: "/blog/mobile-vehicle-services-scheduling-route-planning-australia" },
                { name: "Caravan & RV Servicing", href: "/blog/mobile-vehicle-services-scheduling-route-planning-australia" },
                { name: "Scaffolding", href: "/blog/industrial-site-services-job-scheduling-australia" },
                { name: "Plumbing", href: "/blog/plumbing-business-scheduling-route-planning-australia" },
                { name: "Electrical", href: "/blog/electrician-job-scheduling-route-planning-australia" },
                { name: "Gas Fitting", href: "/blog/property-inspection-surveying-scheduling-australia" },
                { name: "Floor Sanding & Polishing", href: "/blog/specialist-trades-job-scheduling-tips-australia" },
                { name: "Waterproofing", href: "/blog/specialist-trades-job-scheduling-tips-australia" },
                { name: "Demolition", href: "/blog/industrial-site-services-job-scheduling-australia" },
                { name: "Asbestos Removal", href: "/blog/industrial-site-services-job-scheduling-australia" },
                { name: "Fire Protection Services", href: "/blog/industrial-site-services-job-scheduling-australia" },
                { name: "Signage & Wrapping", href: "/blog/mobile-education-creative-services-scheduling-australia" },
                { name: "Mobile Welding", href: "/blog/industrial-site-services-job-scheduling-australia" },
                { name: "Air Duct Cleaning", href: "/blog/specialist-cleaning-business-scheduling-australia" },
                { name: "Grease Trap Cleaning", href: "/blog/waste-environmental-services-scheduling-australia" },
                { name: "Septic Tank Services", href: "/blog/waste-environmental-services-scheduling-australia" },
                { name: "Mobile Mechanic", href: "/blog/mobile-mechanic-business-guide-australia" },
                { name: "Bicycle Repair", href: "/blog/mobile-bicycle-repair-small-equipment-services-australia" },
                { name: "Tutoring & Education", href: "/blog/mobile-education-creative-services-scheduling-australia" },
                { name: "Music Lessons", href: "/blog/mobile-education-creative-services-scheduling-australia" },
                { name: "Aged Care Services", href: "/blog/aged-care-home-care-scheduling-route-planning-australia" },
                { name: "Home Nursing", href: "/blog/aged-care-home-care-scheduling-route-planning-australia" },
                { name: "Occupational Therapy", href: "/blog/allied-health-home-visit-scheduling-route-planning-australia" },
                { name: "Speech Therapy", href: "/blog/allied-health-home-visit-scheduling-route-planning-australia" },
                { name: "Dietitian (Home Visits)", href: "/blog/allied-health-home-visit-scheduling-route-planning-australia" },
                { name: "Real Estate Photography", href: "/blog/mobile-education-creative-services-scheduling-australia" },
                { name: "Drone Services", href: "/blog/mobile-education-creative-services-scheduling-australia" },
                { name: "Surveying", href: "/blog/property-inspection-surveying-scheduling-australia" },
                { name: "Building Inspection", href: "/blog/property-inspection-surveying-scheduling-australia" },
              ].map((service) => (
                <Link
                  key={service.name}
                  href={service.href}
                  className="inline-flex items-center rounded-full bg-primary/10 px-3 sm:px-4 py-1.5 text-xs sm:text-sm font-medium text-primary hover:bg-primary/20 transition-colors"
                >
                  {service.name}
                </Link>
              ))}
