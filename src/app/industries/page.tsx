        ...
        <section className="py-12 sm:py-20 border-t border-border">
          <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
            ...
            <div className="flex flex-wrap gap-2 sm:gap-3">
              {[
                { name: "Painting & Decorating", href: "/handyman-job-management-route-invoicing-app-australia" },
                { name: "Roofing", href: "/handyman-job-management-route-invoicing-app-australia" },
                { name: "Fencing", href: "/handyman-job-management-route-invoicing-app-australia" },
                { name: "Carpet Cleaning", href: "/cleaning-business-scheduling-invoicing-app-australia" },
                { name: "Window Cleaning", href: "/cleaning-business-scheduling-invoicing-app-australia" },
                { name: "Gutter Cleaning", href: "/cleaning-business-scheduling-invoicing-app-australia" },
                { name: "Solar Panel Cleaning", href: "/pressure-washing-business-route-invoicing-app-australia" },
                { name: "Solar Installation", href: "/route-planning-for-service-businesses-australia" },
                { name: "Tree Services & Arborist", href: "/gardening-business-scheduling-invoicing-app-australia" },
                { name: "Concreting & Paving", href: "/handyman-job-management-route-invoicing-app-australia" },
                { name: "Tiling", href: "/handyman-job-management-route-invoicing-app-australia" },
                { name: "Plastering & Rendering", href: "/handyman-job-management-route-invoicing-app-australia" },
                { name: "Skip Bin & Waste Removal", href: "/route-planning-for-service-businesses-australia" },
                { name: "House Washing", href: "/pressure-washing-business-route-invoicing-app-australia" },
                { name: "Lawn Care & Turf", href: "/gardening-business-scheduling-invoicing-app-australia" },
                ...
                { name: "Plumbing", href: "/handyman-job-management-route-invoicing-app-australia" },
                { name: "Electrical", href: "/handyman-job-management-route-invoicing-app-australia" },
                { name: "Gas Fitting", href: "/hot-water-service-business-scheduling-invoicing-app-australia" },
                { name: "Floor Sanding & Polishing", href: "/handyman-job-management-route-invoicing-app-australia" },
                { name: "Waterproofing", href: "/handyman-job-management-route-invoicing-app-australia" },
                ...
                { name: "Aged Care Services", href: "/ndis-support-worker-route-planner-invoicing-app-australia" },
                { name: "Home Nursing", href: "/ndis-support-worker-route-planner-invoicing-app-australia" },
                { name: "Occupational Therapy", href: "/ndis-support-worker-route-planner-invoicing-app-australia" },
                { name: "Speech Therapy", href: "/ndis-support-worker-route-planner-invoicing-app-australia" },
                { name: "Dietitian (Home Visits)", href: "/ndis-support-worker-route-planner-invoicing-app-australia" },
